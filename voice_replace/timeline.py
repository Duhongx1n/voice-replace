...
from voice_replace.dialogue_analysis import (
...
# 向后兼容：保留旧名称
_analyze_dialogue_structure = analyze_dialogue_structure
...
# segments_as_slots 已迁移到 dialogue_analysis.py，此处通过导入保持兼容
...
# _analyze_dialogue_structure 已迁移到 dialogue_analysis.py，此处通过导入保持兼容
